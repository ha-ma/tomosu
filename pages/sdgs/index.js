          ...
          <ul className={styles.sdgs__objective__list}>
            <li className={styles.sdgs__objective__item}>
              <div className={styles.sdgs__objective__detail}>
                ...
                <p className={styles.sdgs__objective__desc}>あらゆる場所のあらゆる形態の貧困を終わらせる</p>
            ...
            <li className={styles.sdgs__objective__item}>
              <div className={styles.sdgs__objective__detail}>
                ...
                <p className={styles.sdgs__objective__desc}>飢餓を終わらせ、食糧安全保障および栄養改善を実現し、持続可能な農業を促進する</p>
                {/* <div className={styles.sdgs__objective__link}>
                  <Link href="/article">
                    <a>〉関連記事を読む</a>
                  </Link>
            ...
            <li className={styles.sdgs__objective__item}>
              <div className={styles.sdgs__objective__detail}>
                ...
                <p className={styles.sdgs__objective__desc}>あらゆる年齢のすべての人々の健康的な生活を確保し、福祉を促進する</p>
                {/* <div className={styles.sdgs__objective__link}>
                  <Link href="/article">
                    <a>〉関連記事を読む</a>
                  </Link>
            ...
            <li className={styles.sdgs__objective__item}>
              <div className={styles.sdgs__objective__detail}>
                ...
                <p className={styles.sdgs__objective__desc}>すべての人に包摂的かつ公正な質の高い教育を確保し生涯学習の機会を促進する</p>
                {/* <div className={styles.sdgs__objective__link}>
                  <Link href="/article">
                    <a>〉関連記事を読む</a>
                  </Link>
            ...
            <li className={styles.sdgs__objective__item}>
              <div className={styles.sdgs__objective__detail}>
                ...
                <p className={styles.sdgs__objective__desc}>ジェンダー平等を達成し、すべての女性および女児の能力強化を行う</p>
                {/* <div className={styles.sdgs__objective__link}>
                  <Link href="/article">
                    <a>〉関連記事を読む</a>
                  </Link>
            ...
            <li className={styles.sdgs__objective__item}>
              <div className={styles.sdgs__objective__detail}>
                ...
                <p className={styles.sdgs__objective__desc}>すべての人々の水と衛生の利用可能性と持続可能な管理を確保する</p>
                {/* <div className={styles.sdgs__objective__link}>
                  <Link href="/article">
                    <a>〉関連記事を読む</a>
                  </Link>
            ...
            <li className={styles.sdgs__objective__item}>
              <div className={styles.sdgs__objective__detail}>
                ...
                <p className={styles.sdgs__objective__desc}>すべての人々の、安価かつ信頼できる持続可能な近代的エネルギーへのアクセスを確保する</p>
                {/* <div className={styles.sdgs__objective__link}>
                  <Link href="/article">
                    <a>〉関連記事を読む</a>
                  </Link>
            ...
            <li className={styles.sdgs__objective__item}>
              <div className={styles.sdgs__objective__detail}>
                ...
                <p className={styles.sdgs__objective__desc}>包摂的かつ持続可能な経済成長及びすべての人々の完全かつ生産的雇用と働きがいのある人間らしい雇用（ディーセント・ワーク）を促進する</p>
                {/* <div className={styles.sdgs__objective__link}>
                  <Link href="/article">
                    <a>〉関連記事を読む</a>
                  </Link>
            ...
            <li className={styles.sdgs__objective__item}>
              <div className={styles.sdgs__objective__detail}>
                ...
                <p className={styles.sdgs__objective__desc}>強靭（レジリエント）なインフラ構築、包摂的かつ持続可能な産業化の促進及びイノベーションの推進を図る</p>
                {/* <div className={styles.sdgs__objective__link}>
                  <Link href="/article">
                    <a>〉関連記事を読む</a>
                  </Link>
            ...
            <li className={styles.sdgs__objective__item}>
              <div className={styles.sdgs__objective__detail}>
                ...
                <p className={styles.sdgs__objective__desc}>各国内および各国間の不平等を是正する</p>
                {/* <div className={styles.sdgs__objective__link}>
                  <Link href="/article">
                    <a>〉関連記事を読む</a>
                  </Link>
            ...
            <li className={styles.sdgs__objective__item}>
              <div className={styles.sdgs__objective__detail}>
                ...
                <p className={styles.sdgs__objective__desc}>包摂的で安全かつ強靭（レジリエント）で持続可能な都市および人間居住を実現する</p>
                {/* <div className={styles.sdgs__objective__link}>
                  <Link href="/article">
                    <a>〉関連記事を読む</a>
                  </Link>
            ...
            <li className={styles.sdgs__objective__item}>
              <div className={styles.sdgs__objective__detail}>
                ...
                <p className={styles.sdgs__objective__desc}>持続可能な生産消費形態を確保する</p>
                {/* <div className={styles.sdgs__objective__link}>
                  <Link href="/article">
                    <a>〉関連記事を読む</a>
                  </Link>
            ...
            <li className={styles.sdgs__objective__item}>
              <div className={styles.sdgs__objective__detail}>
                ...
                <p className={styles.sdgs__objective__desc}>気候変動及びその影響を軽減するための緊急対策を講じる</p>
                {/* <div className={styles.sdgs__objective__link}>
                  <Link href="/article">
                    <a>〉関連記事を読む</a>
                  </Link>
            ...
            <li className={styles.sdgs__objective__item}>
              <div className={styles.sdgs__objective__detail}>
                ...
                <p className={styles.sdgs__objective__desc}>持続可能な開発のために海洋・海洋資源を保全し、持続可能な形で利用する</p>
                {/* <div className={styles.sdgs__objective__link}>
                  <Link href="/article">
                    <a>〉関連記事を読む</a>
                  </Link>
            ...
            <li className={styles.sdgs__objective__item}>
              <div className={styles.sdgs__objective__detail}>
                ...
                <p className={styles.sdgs__objective__desc}>陸域生態系の保護、回復、持続可能な利用の推進、持続可能な森林の経営、砂漠化への対処、並びに土地の劣化の阻止・回復及び生物多様性の損失を阻止する</p>
                {/* <div className={styles.sdgs__objective__link}>
                  <Link href="/article">
                    <a>〉関連記事を読む</a>
                  </Link>
            ...
            <li className={styles.sdgs__objective__item}>
              <div className={styles.sdgs__objective__detail}>
                ...
                <p className={styles.sdgs__objective__desc}>持続可能な開発のための平和で包摂的な社会を促進し、すべての人々に司法へのアクセスを提供し、あらゆるレベルにおいて効果的で説明責任のある包摂的な制度を構築する</p>
                {/* <div className={styles.sdgs__objective__link}>
                  <Link href="/article">
                    <a>〉関連記事を読む</a>
                  </Link>
            ...
            <li className={styles.sdgs__objective__item}>
              <div className={styles.sdgs__objective__detail}>
                ...
                <p className={styles.sdgs__objective__desc}>持続可能な開発のための実施手段を強化し、グローバル・パートナーシップを活性化する</p>
                {/* <div className={styles.sdgs__objective__link}>
                  <Link href="/article">
                    <a>〉関連記事を読む</a>
                  </Link>
