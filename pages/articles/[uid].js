...
import { sdgsDisplayGenerator, sdgsIconSwitch } from "../../components/sdgsDisplayGenerator";
const Article = ({ doc }) => {
        ...
        <section className={styles.articlesdetail}>
          <div className={styles.articlesdetail__container}>
                        ...
                        if (value.display) {
                          return (
                            <li className={styles.articlesdetail__heading__iconItem}>
                              <Image src={sdgsIconSwitch(value.name)} quality={100} width={1276} height={1276} />
                            </li>
                          );
                        }
                      })}
            ...
            <div className={styles.articlesdetail__relatedLink}>
              ...
              <div className={styles.articlesdetail__relatedLink__img}>{hasIntervieweePic ? <Image src={doc.data.interviewee_pic.url} quality={100} width={321} height={322} /> : <Image src="/images/noimage.png" quality={100} width={321} height={322} />}</div>
              <p className={styles.articlesdetail__relatedLink__desc}>{interviewee_profile}</p>
              {hasInterviweeLink && (
                <a href={interviewee_link} className={styles.articlesdetail__relatedLink__link} target="_blank">
                      ...
                      <ul className={styles.articlesdetail__pickup__tag}>
                        {tags.map(tag => (
                          <li className={styles.articlesdetail__pickup__tag__item}>
                            ...
                            >
                              <a className={styles.articlesdetail__pickup__tag__link}>#{`${tag}`}</a>
                            </Link>
                          </li>
                        ))}
                      </ul>
