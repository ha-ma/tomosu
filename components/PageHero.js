  ...
  return (
    <section className={styles.PageHero}>
      <div className={styles.PageHero__container}>
        ...
        {path != "/" && <h1 className={styles.PageHero__heading}>{path === "/articles" ? "記事一覧" : path === "/about" ? "私たちのこと" : path === "/sdgs" ? "SDGsについて" : path === "/contact" ? "お問い合わせ" : path === "/news" ? "お知らせ" : path === "/privacy-policy" ? "プライバシーポリシー" : ""}</h1>}
      </div>
    </section>
  );
}
